      ...
      <body>
        <header>
          ...
          <div class="aboutfeeds">
            ...
            <p>To learn more about RSS, read <a href="https://aboutfeeds.com/" target="_blank"><em>About Feeds</em></a> by Matt Webb.</p>
          </div>
          <div class="head">
            <div class="avatar">
              <img src="/assets/images/smp-logo-invert.svg" alt="Silvia Maggi"/>
            </div>
        ...
        <main>
          ...
          <p class="about"><img src="/assets/images/favicons/favicon.svg" alt="Silvia Maggi icon" width="24" height="24" /><a href="/about/">About Silvia Maggi</a>.</p>
        </main>
      </body>
    </html>
  </xsl:template>
